      ...
      <header className='w-screen h-screen flex flex-col background'>
        ...
        <div className='flex flex-row justify-center items-center w-screen h-screen'>
          <div className='m-28'>
            ...
            <span className='text-3xl font-bold font-nunito'>Full Stack Developer</span>
            <div className='my-4'>
            ...
            <div className="social flex flex-row flex-wrap w-full gap-4 text-3xl">
              <div className="icon cursor-pointer hover:opacity-80 text-zinc-900"><FontAwesomeIcon icon={faGithub} /></div>
              <div className="icon cursor-pointer hover:opacity-80 text-zinc-900"><FontAwesomeIcon icon={faInstagram} /></div>
              <div className="icon cursor-pointer hover:opacity-80 text-zinc-900"><FontAwesomeIcon icon={faLinkedin} /></div>
            </div>
          </div>
